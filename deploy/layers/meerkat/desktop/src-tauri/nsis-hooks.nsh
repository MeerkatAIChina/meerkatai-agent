!macro MEERKAT_KILL_INSTDIR_PROCESSES
  ...
  FileWrite $0 'Get-CimInstance Win32_Process | Where-Object -Property ExecutablePath -Like -Value "$$dir\*" | Where-Object { $$_.Name -ine "uninstall.exe" } | Invoke-CimMethod -MethodName Terminate$\r$\n'
  FileClose $0
