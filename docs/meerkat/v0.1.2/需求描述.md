...
1. 进行 i18n 国际化的翻译，将界面的英文转换成简体中文，且默认就是中文。
2. 部分字要换掉，比如产品左上角的 QM 换成 MeerkatAI，原来的 Meerkat 换成 MAPID，如图 ![标题切换](./assets/标题切换.png)
3. desktop 产品图标需要更换，图标见 ![meerkat_icon.png](./assets/meerkat_icon.png)
...
### 1. ✅ 已修复：core 启动自动清理死租约，session busy 即时恢复

问题地址：👉️ <https://github.com/MeerkatAIChina/meerkatai-agent/issues/5>

修复于本迭代（commit `97826a8`），issue 已关闭，列入仅为归档记录。
